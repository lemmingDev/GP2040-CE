...
export const INPUT_MODE_OPTIONS: InputModeOptions[] = [
	...
	{
		labelKey: 'input-mode-options.switch-bluetooth',
		value: InputMode.INPUT_MODE_SWITCH_BT,
		group: 'primary',
		required: [],
		optional: [],
		authentication: [],
	...
	{
		labelKey: 'input-mode-options.hid-bluetooth',
		value: InputMode.INPUT_MODE_HID_BT,
		group: 'primary',
		required: [],
		optional: [],
		authentication: [],
