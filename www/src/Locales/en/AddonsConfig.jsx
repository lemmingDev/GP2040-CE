export default {
	...
	'analog-adc2-wifi-note':
		'Note: GPIO11-20 (ADC2, marked in the lists) are analog-capable only while WiFi is disabled. WiFi normally runs for webconfig access, so prefer the ADC1 pins (GPIO1-10).',
