...
// active. The PS4 function uses IN 0x81 / OUT 0x03, so the first-free rule
// gives notif intr 0x83, bulk OUT 0x04, bulk IN 0x85; RNDIS takes interfaces
// 1+2 (comm + data), hence bNumInterfaces 1 -> 3.
#define PS4_CONFIG1_DESC_SIZE_WITH_NET	(PS4_CONFIG1_DESC_SIZE + TUD_RNDIS_DESC_LEN)
...
// S3 USB-webconfig (Task 6): PS4 function byte-identical to
// ps4_configuration_descriptor, followed by the RNDIS function
...
static const uint8_t ps4_configuration_descriptor_with_net[] =
{
	// configuration descriptor, USB spec 9.6.3, page 264-266, Table 9-10
	9,						       // bLength;
	2,						       // bDescriptorType;
	LSB(PS4_CONFIG1_DESC_SIZE_WITH_NET),    // wTotalLength
	MSB(PS4_CONFIG1_DESC_SIZE_WITH_NET),
	3,	                           // bNumInterfaces
	1,	                           // bConfigurationValue
	0,	                           // iConfiguration
	0x80,                          // bmAttributes
