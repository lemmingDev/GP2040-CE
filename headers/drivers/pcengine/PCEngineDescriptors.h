...
// S3 USB-webconfig (Task 7): PCEngine function byte-identical to
// pcengine_configuration_descriptor, followed by the RNDIS function
// (TUD_RNDIS_DESCRIPTOR argument order: itf, str, ep_notif, notif_size,
// epout, epin, epsize). The PCEngine function uses OUT 0x02 / IN 0x81, so
...
static const uint8_t pcengine_configuration_descriptor_with_net[] =
{
    0x09,        // bLength
    0x02,        // bDescriptorType (Configuration)
