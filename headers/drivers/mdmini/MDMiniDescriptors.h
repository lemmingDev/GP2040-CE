...
// S3 USB-webconfig (Task 7): MDMini function byte-identical to
// mdmini_configuration_descriptor, followed by the RNDIS function
// (TUD_RNDIS_DESCRIPTOR argument order: itf, str, ep_notif, notif_size,
// epout, epin, epsize). The MDMini function uses OUT 0x02 / IN 0x81, so the
...
static const uint8_t mdmini_configuration_descriptor_with_net[] =
{
	0x09,        // bLength
	0x02,        // bDescriptorType (Configuration)
