...
// S3 USB-webconfig (Task 7): Egret function byte-identical to
// egret_configuration_descriptor, followed by the RNDIS function
// (TUD_RNDIS_DESCRIPTOR argument order: itf, str, ep_notif, notif_size,
// epout, epin, epsize). The Egret function uses OUT 0x02 / IN 0x81, so the
...
static const uint8_t egret_configuration_descriptor_with_net[] =
{
    0x09,        // bLength
    0x02,        // bDescriptorType (Configuration)
