...
typedef enum _InputMode {
    ...
    /* S3 port: Bluetooth HID mode (not upstreamed; appended after upstream
 values — was 15 on the pre-merge branch, so erase gpconfig once after
 updating (stale 15 would decode as Switch Pro)). */
    INPUT_MODE_BLUETOOTH = 18,
...
typedef enum _AnimationNonPressedEffects {
    ...
    AnimationNonPressedEffects_EFFECT_CHASE_INDEX = 3,
    AnimationNonPressedEffects_EFFECT_CHASE_SEQUENTIAL = 4,
    AnimationNonPressedEffects_EFFECT_CHASE_CIRCLE_CLOCKWISE = 5,
    AnimationNonPressedEffects_EFFECT_CHASE_CIRCLE_ANTICLOCKWISE = 6,
    AnimationNonPressedEffects_EFFECT_CHASE_LEFT_TO_RIGHT = 7,
    AnimationNonPressedEffects_EFFECT_CHASE_RIGHT_TO_LEFT = 8,
    AnimationNonPressedEffects_EFFECT_CHASE_TOP_TO_BOTTOM = 9,
    AnimationNonPressedEffects_EFFECT_CHASE_BOTTOM_TO_TOP = 10,
    AnimationNonPressedEffects_EFFECT_CHASE_INDEX_PINGPONG = 11,
    AnimationNonPressedEffects_EFFECT_CHASE_SEQUENTIAL_PINGPONG = 12,
    AnimationNonPressedEffects_EFFECT_CHASE_CIRCLE_PINGPONG = 13,
    AnimationNonPressedEffects_EFFECT_CHASE_HORIZONTAL_PINGPONG = 14,
    AnimationNonPressedEffects_EFFECT_CHASE_VERTICAL_PINGPONG = 15,
    AnimationNonPressedEffects_EFFECT_CHASE_RANDOM = 16,
    AnimationNonPressedEffects_EFFECT_JIGGLESTATIC = 17,
    AnimationNonPressedEffects_EFFECT_JIGGLETWOSTATICS = 18,
    AnimationNonPressedEffects_EFFECT_RAIN = 19
...
#define InputMode_INPUT_MODE_SINPUT INPUT_MODE_SINPUT
#define InputMode_INPUT_MODE_BLUETOOTH INPUT_MODE_BLUETOOTH
...
#define _GpioAction_MAX SUSTAIN_PROFILE_SLIDER_POSITION_8
#define _GpioAction_ARRAYSIZE ((GpioAction)(SUSTAIN_PROFILE_SLIDER_POSITION_8+1))
...
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_1 SUSTAIN_PROFILE_SLIDER_POSITION_1
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_2 SUSTAIN_PROFILE_SLIDER_POSITION_2
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_3 SUSTAIN_PROFILE_SLIDER_POSITION_3
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_4 SUSTAIN_PROFILE_SLIDER_POSITION_4
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_5 SUSTAIN_PROFILE_SLIDER_POSITION_5
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_6 SUSTAIN_PROFILE_SLIDER_POSITION_6
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_7 SUSTAIN_PROFILE_SLIDER_POSITION_7
#define GpioAction_SUSTAIN_PROFILE_SLIDER_POSITION_8 SUSTAIN_PROFILE_SLIDER_POSITION_8
...
#define _GamepadHotkey_MAX HOTKEY_REBOOT_USB
#define _GamepadHotkey_ARRAYSIZE ((GamepadHotkey)(HOTKEY_REBOOT_USB+1))
...
#define GamepadHotkey_HOTKEY_REBOOT_WEBCONFIG HOTKEY_REBOOT_WEBCONFIG
#define GamepadHotkey_HOTKEY_REBOOT_USB HOTKEY_REBOOT_USB
...
#define _AnimationNonPressedEffects_MAX AnimationNonPressedEffects_EFFECT_RAIN
#define _AnimationNonPressedEffects_ARRAYSIZE ((AnimationNonPressedEffects)(AnimationNonPressedEffects_EFFECT_RAIN+1))
...
X(INPUT_MODE_SINPUT, 17) \
X(INPUT_MODE_BLUETOOTH, 18) \
...
X(SUSTAIN_PROFILE_SLIDER_POSITION_1, 131) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_2, 132) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_3, 133) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_4, 134) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_5, 135) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_6, 136) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_7, 137) \
X(SUSTAIN_PROFILE_SLIDER_POSITION_8, 138)
...
X(HOTKEY_REBOOT_WEBCONFIG, 86) \
X(HOTKEY_REBOOT_USB, 87)
...
X(AnimationNonPressedEffects_EFFECT_CHASE_INDEX, 3) \
X(AnimationNonPressedEffects_EFFECT_CHASE_SEQUENTIAL, 4) \
X(AnimationNonPressedEffects_EFFECT_CHASE_CIRCLE_CLOCKWISE, 5) \
X(AnimationNonPressedEffects_EFFECT_CHASE_CIRCLE_ANTICLOCKWISE, 6) \
X(AnimationNonPressedEffects_EFFECT_CHASE_LEFT_TO_RIGHT, 7) \
X(AnimationNonPressedEffects_EFFECT_CHASE_RIGHT_TO_LEFT, 8) \
X(AnimationNonPressedEffects_EFFECT_CHASE_TOP_TO_BOTTOM, 9) \
X(AnimationNonPressedEffects_EFFECT_CHASE_BOTTOM_TO_TOP, 10) \
X(AnimationNonPressedEffects_EFFECT_CHASE_INDEX_PINGPONG, 11) \
X(AnimationNonPressedEffects_EFFECT_CHASE_SEQUENTIAL_PINGPONG, 12) \
X(AnimationNonPressedEffects_EFFECT_CHASE_CIRCLE_PINGPONG, 13) \
X(AnimationNonPressedEffects_EFFECT_CHASE_HORIZONTAL_PINGPONG, 14) \
X(AnimationNonPressedEffects_EFFECT_CHASE_VERTICAL_PINGPONG, 15) \
X(AnimationNonPressedEffects_EFFECT_CHASE_RANDOM, 16) \
X(AnimationNonPressedEffects_EFFECT_JIGGLESTATIC, 17) \
X(AnimationNonPressedEffects_EFFECT_JIGGLETWOSTATICS, 18) \
X(AnimationNonPressedEffects_EFFECT_RAIN, 19)
